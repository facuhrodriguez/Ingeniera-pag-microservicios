...
export const DetalleFactura = () => {
  ...
  const detalleFacturaList = useAppSelector(state => state.gateway.detalleFactura.entities);
  ...
  return (
    <div>
      <h2 id="detalle-factura-heading" data-cy="DetalleFacturaHeading">
        <Translate contentKey="gatewayApp.detalleFactura.home.title">Detalle Facturas</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.detalleFactura.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/detalle-factura/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="gatewayApp.detalleFactura.home.createLabel">Create new Detalle Factura</Translate>
          </Link>
        </div>
      </h2>
        ...
        {detalleFacturaList && detalleFacturaList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="gatewayApp.detalleFactura.id">ID</Translate>
                </th>
                <th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/detalle-factura/${detalleFactura.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                      ...
                      <Button
                        tag={Link}
                        to={`/detalle-factura/${detalleFactura.id}/delete`}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.detalleFactura.home.notFound">No Detalle Facturas found</Translate>
            </div>
          )
        )}
      </div>
