...
export const DetalleFacturaDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.detalleFactura.delete.question">
        <Translate contentKey="gatewayApp.detalleFactura.delete.question" interpolate={{ id: detalleFacturaEntity.id }}>
