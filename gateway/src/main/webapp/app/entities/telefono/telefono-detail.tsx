    ...
    <Row>
      <Col md="8">
        <h2 data-cy="telefonoDetailsHeading">
          <Translate contentKey="gatewayApp.telefono.detail.title">Telefono</Translate>
        </h2>
        ...
        <Button tag={Link} to="/telefono" replace color="info" data-cy="entityDetailsBackButton">
        ...
        &nbsp;
        <Button tag={Link} to={`/telefono/${telefonoEntity.id}/edit`} replace color="primary">
