...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './telefono.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ITelefono, defaultValue } from 'app/shared/model/telefono.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TELEFONO_LIST actions', async () => {
    ...
    it('dispatches FETCH_TELEFONO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TELEFONO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TELEFONO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TELEFONO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TELEFONO actions', async () => {
      const expectedActions = [
        {
