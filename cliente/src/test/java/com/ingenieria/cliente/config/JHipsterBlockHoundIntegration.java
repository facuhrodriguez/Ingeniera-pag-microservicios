...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ingenieria.cliente.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ingenieria.cliente.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
