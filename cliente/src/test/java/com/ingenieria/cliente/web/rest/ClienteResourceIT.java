...
import com.ingenieria.cliente.IntegrationTest;
...
class ClienteResourceIT {
    ...
    void createCliente() throws Exception {
        ...
        assertThat(testCliente.getActivo()).isEqualTo(DEFAULT_ACTIVO);
    }
    ...
    void putExistingCliente() throws Exception {
        ...
        updatedCliente.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).direccion(UPDATED_DIRECCION).activo(UPDATED_ACTIVO);
        ...
        assertThat(testCliente.getActivo()).isEqualTo(UPDATED_ACTIVO);
    }
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).direccion(UPDATED_DIRECCION).activo(UPDATED_ACTIVO);
