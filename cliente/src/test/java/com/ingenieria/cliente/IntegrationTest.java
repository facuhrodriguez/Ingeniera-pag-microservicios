...
import com.ingenieria.cliente.ClienteApp;
import com.ingenieria.cliente.config.AsyncSyncConfiguration;
import com.ingenieria.cliente.config.EmbeddedMongo;
...
@SpringBootTest(classes = { ClienteApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
