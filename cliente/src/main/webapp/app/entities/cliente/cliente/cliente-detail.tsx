    ...
    <Row>
      <Col md="8">
        <h2 data-cy="clienteDetailsHeading">
          <Translate contentKey="clienteApp.clienteCliente.detail.title">Cliente</Translate>
        </h2>
        ...
        <Button tag={Link} to="/cliente/cliente" replace color="info" data-cy="entityDetailsBackButton">
        ...
        &nbsp;
        <Button tag={Link} to={`/cliente/cliente/${clienteEntity.id}/edit`} replace color="primary">
