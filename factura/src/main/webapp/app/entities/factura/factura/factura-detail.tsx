    ...
    <Row>
      <Col md="8">
        <h2 data-cy="facturaDetailsHeading">
          <Translate contentKey="facturaApp.facturaFactura.detail.title">Factura</Translate>
        </h2>
        ...
        &nbsp;
        <Button tag={Link} to={`/factura/factura/${facturaEntity.id}/edit`} replace color="primary">
