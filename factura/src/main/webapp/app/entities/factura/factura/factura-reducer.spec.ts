...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './factura.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACTURA_LIST actions', async () => {
    ...
    it('dispatches FETCH_FACTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FACTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FACTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FACTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FACTURA actions', async () => {
      const expectedActions = [
        {
