...
export const ProductoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="facturaApp.facturaProducto.delete.question">
        <Translate contentKey="facturaApp.facturaProducto.delete.question" interpolate={{ id: productoEntity.id }}>
