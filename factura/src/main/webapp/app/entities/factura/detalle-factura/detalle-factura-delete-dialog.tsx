...
import { getEntity, deleteEntity } from './detalle-factura.reducer';
...
export const DetalleFacturaDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="facturaApp.facturaDetalleFactura.delete.question">
        <Translate contentKey="facturaApp.facturaDetalleFactura.delete.question" interpolate={{ id: detalleFacturaEntity.id }}>
          Are you sure you want to delete this DetalleFactura?
        </Translate>
      </ModalBody>
      <ModalFooter>
