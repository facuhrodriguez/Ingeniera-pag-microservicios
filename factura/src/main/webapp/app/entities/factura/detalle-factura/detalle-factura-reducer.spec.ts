...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DETALLEFACTURA_LIST actions', async () => {
    ...
    it('dispatches FETCH_DETALLEFACTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DETALLEFACTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DETALLEFACTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DETALLEFACTURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DETALLEFACTURA actions', async () => {
      const expectedActions = [
        {
