...
import com.ingenieria.factura.repository.ProductoRepository;
...
/**
 * REST controller for managing {@link com.ingenieria.factura.domain.Producto}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductoResource {
    ...
    private static final String ENTITY_NAME = "facturaProducto";
