...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ingenieria.factura.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ingenieria.factura.security.DomainUserDetailsService", "createSpringSecurityUser");
