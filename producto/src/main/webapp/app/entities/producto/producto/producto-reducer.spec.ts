...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './producto.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IProducto, defaultValue } from 'app/shared/model/producto/producto.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTO actions', async () => {
      const expectedActions = [
        {
