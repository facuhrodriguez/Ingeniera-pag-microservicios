...
export const ProductoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productoApp.productoProducto.delete.question">
        <Translate contentKey="productoApp.productoProducto.delete.question" interpolate={{ id: productoEntity.id }}>
