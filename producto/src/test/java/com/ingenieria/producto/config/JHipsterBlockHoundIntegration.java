...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ingenieria.producto.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ingenieria.producto.security.DomainUserDetailsService", "createSpringSecurityUser");
